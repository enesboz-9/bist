...
BIST_STATIK = {
    ...
    "ALBRK":"Albaraka Türk","ARCLK":"Arçelik","ASELS":"Aselsan","ASTOR":"Astor Enerji",
    "ASUZU":"Anadolu Isuzu","AYDEM":"Aydem Enerji","BAGFS":"Bagfaş","BERA":"Bera Holding",
    "BIMAS":"Bim Mağazalar","BRSAN":"Borusan Boru","BRYAT":"Borusan Yatırım","BUCIM":"Bursa Çimento",
    "CCOLA":"Coca-Cola İçecek","CIMSA":"Çimsa","CWENE":"Cw Enerji","DOAS":"Doğuş Otomotiv",
    "DOHOL":"Doğan Holding","EKGYO":"Emlak Konut GYO","ENJSA":"Enerjisa Enerji","ENKAI":"Enka İnşaat",
    "EREGL":"Ereğli Demir Çelik","FROTO":"Ford Otosan","GARAN":"Garanti Bankası","GESAN":"Girişim Elektrik",
    "GUBRF":"Gübre Fabrikaları","GWIND":"Galata Wind","HALKB":"Halkbank","HEKTS":"Hektaş",
    "ISCTR":"İş Bankası (C)","ISDMR":"İskenderun Demir Çelik","ISGYO":"İş GYO","ISMEN":"İş Yatırım",
    "KCHOL":"Koç Holding","KENT":"Kent Gıda","KORDS":"Kordsa","KOZAA":"Koza Madencilik",
    "KOZAL":"Koza Altın","KRDMD":"Kardemir (D)","MAVI":"Mavi Giyim","MGROS":"Migros",
    "ODAS":"Odaş Elektrik","OTKAR":"Otokar","OYAKC":"Oyak Çimento","PENTA":"Penta Teknoloji",
    "PETKM":"Petkim","PGSUS":"Pegasus","SAHOL":"Sabancı Holding","SASA":"Sasa Polyester",
    "SISE":"Şişecam","SKBNK":"Şekerbank","SOKM":"Şok Marketler","TAVHL":"Tav Havalimanları",
    ...
    "VESTL":"Vestel","YKBNK":"Yapı Kredi Bankası","ZOREN":"Zorlu Enerji",
    "ADEL":"Adel Kalemcilik","AKGRT":"Aksigorta","ANACM":"Anadolu Cam","AYEN":"Ayen Enerji",
    "BANVT":"Banvit","BIZIM":"Bizim Toptan","BTCIM":"Batıçim","BURCE":"Burçelik",
    "CEMAS":"Çemaş Döküm","CLEBI":"Çelebi Hava Servisi","DEVA":"Deva Holding",
    "DGATE":"Datagate Bilgisayar","DITAS":"Ditaş Doğan","DOKTA":"Döktaş","DYOBY":"Dyo Boya",
    "ECILC":"Eczacıbaşı İlaç","ECZYT":"Eczacıbaşı Yatırım","EGPRO":"Ege Profil","ERBOS":"Erbosan",
    "FENER":"Fenerbahçe","FONET":"Fonet Bilgi","FRIGO":"Frigo-Pak","GARFA":"Garanti Faktoring",
    "GEDIK":"Gedik Yatırım","GEMAS":"Gemsan Elektrik","GLYHO":"Global Yatırım Holding",
    "GOLTS":"Göltaş Çimento","GOODY":"Goodyear","GSDHO":"GSD Holding","GSRAY":"Galatasaray",
    "HDFGS":"Hedef Girişim","ICBCT":"ICBC Turkey","INDES":"İndeks Bilgisayar","INFO":"İnfo Yatırım",
    "INTEM":"İntema İnşaat","ISGSY":"İş GY Ortaklığı","ITTFH":"İttifak Holding","IZOCM":"İzoçam",
    "JANTS":"Jantsa Jant","KAPLM":"Kaplamin Ambalaj","KAREL":"Karel Elektronik","KARSN":"Karsan",
    "KATMR":"Katmerciler","KERVN":"Kervan Gıda","KLKIM":"Kalekim","KONYA":"Konya Çimento",
    "KRDMA":"Kardemir A","KRDMB":"Kardemir B","KUTPO":"Kütahya Porselen","LIDER":"Lider Faktoring",
    "LINK":"Link Bilgisayar","LOGO":"Logo Yazılım","MAKIM":"Makina Takım","MARTI":"Martı Otel",
    "MEDTR":"Meditera Tıp","MERKO":"Merko Gıda","MNDRS":"Menderes Tekstil","MTRKS":"Matriks Bilgi",
    "NETAS":"Netaş Telekomünikasyon","NIBAS":"Niğbaş Niğde","NTHOL":"Net Holding","NUHCM":"Nuh Çimento",
    "OBASE":"Obase","ORGE":"Orge Enerji","OYLUM":"Oylum Tarım","OZGYO":"Özak GYO",
    "PAMEL":"Pamel Yenilenebilir","PARSN":"Parsan","PENGD":"Penguen Gıda","PETUN":"Pınar Et ve Un",
    "PINSU":"Pınar Su","PKART":"Plastkart","POLHO":"Polisan Holding","RDFGY":"Roda GYO",
    "RGYAS":"Reysaş GYO","ROYAL":"Royal Halı","SAMAT":"Samatya Cam","SELEC":"Selçuk Ecza",
    "SELGD":"Selçuk Gıda","SNGYO":"Sinpaş GYO","SODSN":"Soda Sanayii","SUWEN":"Süwen Tekstil",
    "TBORG":"Türk Tuborg","TRGYO":"Torunlar GYO","TRPAP":"Türk Prysmian Kablo","TSPOR":"Trabzonspor",
    "TUKAS":"Tukaş","ULUSE":"Ulusoy Elektrik","ULUUN":"Ulusoy Un","USAK":"Uşak Seramik",
    "VAKGY":"Vakıf GYO","VAKKO":"Vakko Tekstil","VBTYZ":"VBT Yazılım","VERUS":"Verusa Holding",
    "YBTAS":"Yıbıtaş","YNSYT":"Yensayt","YUNSA":"Yünsa","ZEDUR":"Zedur Enerji","ZRGYO":"Ziraat GYO",
}
